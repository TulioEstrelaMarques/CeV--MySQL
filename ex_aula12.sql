...
between '2000-01-01' and '2015-12-31' order by nascimento;

#3
select nome from gafanhotos where profissao = 'Programador' 
and sexo = 'M' order by nome;

#4
select * from gafanhotos where sexo = 'F'
and nacionalidade = 'Brasil' and nome like 'J%';
...
#8
select min(peso) from gafanhotos where sexo = 'F'
and nacionalidade <> 'Brasil' and nascimento between '1990-01-01'
and '2000-12-31';
